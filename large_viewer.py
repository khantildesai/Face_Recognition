...
#scale_width = screen_res[0] / video_capture.shape[1]
#scale_height = screen_res[1] / video_capture.shape[0]
        ...
        if process_this_frame:
            ...
            for face_encoding in face_encodings:
                ...
                if name == "Unknown":
                    ...
                    t, r, b, l = face_locations[-1][0] *2, face_locations[-1][1] *2, face_locations[-1][2]*2, face_locations[-1][3]*2
